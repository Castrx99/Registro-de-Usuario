window.onload=()=>{
    ...
    form.reset.addEventListener("click" , ()=>{
        ...
        let mensajeError=document.querySelectorAll.apply(".msn");//eliminando los mensajes de error que hayan en el html
...
function validarNombre(){
   ...
   if(!nombre.value.trim()){//si esta vacio...
    ...
    nombre.classList.add("errorInput");
    nombre.classList.remove("validoInput");
    msnError.textContent="El nombre solo puede contener letrar y espacio";
    return false;
   }else{
...
function validarApellido(){
   ...
   if(!apellido.value.trim()){//si esta vacio...
    ...
    apellido.classList.add("errorInput");
    apellido.classList.remove("validoInput");
    msnError.textContent="El apellido solo puede contener letrar y espacio";
    return false;
   }else{
...
function validarEdad(){
    ...
    if(isNaN(edad.value) || !edad.value.trim()){
        ...
        msnError.textContent="La edad solo puede contener números entre 0 y 100";
        return false;
    } else if (edad.value<=0 || edad.value>100){
        edad.classList.add("errorInput");
        edad.classList.remove("validoInput");
        msnError.textContent="La edad debe ser mayor de 0";
        return false;
    } else{
...
function validarTelefono(){
    ...
    if(!telefono.value.trim()){
        ...
        telefono.classList.add("errorInput");
        telefono.classList.remove("validoInput");
        msnError.textContent="El telefono debe contener números, que empiece por 6,7,8,9 y debe de tener 9 números como máximo";
        return false;
       }else{
